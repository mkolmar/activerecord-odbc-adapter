...
module ActiveRecord
  ...
  module ConnectionAdapters
    class ODBCAdapter < AbstractAdapter
      ...
      def new_column(name, default, sql_type_metadata = nil, null = true, default_function = nil, native_type = nil, collation: nil, comment: nil)
        ::ODBCAdapter::Column.new(name, default, sql_type_metadata, null, default_function, native_type, collation: collation, comment: comment)
      end
